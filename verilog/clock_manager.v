...
//   - clk_100m_adc: ADC, DDC, windowing, and FFT receive path.
...
`ifdef USE_LIFMD6000_PLL
    ...
    // The ADC is clocked directly from the board's 100 MHz reference.  Only
    // the Ethernet domain requires frequency synthesis.
    assign clk_100m_adc = clk_100m_in;
...
`endif
    ...
    assign clk_600m = clk_100m_adc;
    assign clk_1200m_fft = clk_100m_adc;
