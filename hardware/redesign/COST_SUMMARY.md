...
| Metric | USD | INR at 96.53900 INR/USD |
|---|---:|---:|
| Existing V1 BOM | $119.43 | Rs 11,530 |
| Corrected V2 BOM, QPC6144 budgeted at $6.00 | $147.90 | Rs 14,278 |
| V2 minus V1 | $28.47 | Rs 2,748 |

## Comparable 1,000-unit assembled allowance

This adds conservative PCB allowances of
**$0.04/cm2 for V1** and
**$0.05/cm2 for the 99 x 99 mm four-layer V2**,
current public high-volume automated/manual joint rates, and the same
$0.24/board X-ray allowance to both designs.
...
| Metric | USD | INR at 96.53900 INR/USD |
|---|---:|---:|
| Existing V1 assembled allowance | $123.96 | Rs 11,967 |
| Corrected V2 assembled allowance | $155.78 | Rs 15,039 |
| V2 minus V1 | $31.82 | Rs 3,072 |

On the BOM-only comparison, QPC6144 can cost up to $17.53. After
the PCB/assembly allowances, its quote must be no more than
**$14.18 per unit** to keep V2 within the hard
$40 increment. At the
$6.00 planning value, the full comparable redesign is
$8.18 below that limit.
