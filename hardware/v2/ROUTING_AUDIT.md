...
| Stale footprint-library warnings | 3 |
...
The 33 router residuals were independently reproduced as 18 RF, 6 digital, and 9 default/control routes.

## Finish-sweep method

The finish sweep starts from the clean routed checkpoint and evaluates every modification independently. A candidate is retained only when it:
...
| Freerouting 1.9 tournament | no importable candidate |
| Freerouting 2.0.1 tournament | no importable candidate |

These results are retained as workflow artifacts and PR discussions. Only the clean final integration branch is eligible for merge.
